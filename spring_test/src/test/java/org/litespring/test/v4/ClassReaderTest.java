...
public class ClassReaderTest {
	...
	public void testGetClassMetaData() throws IOException {
		...
		assertEquals(visitor.getClassName(), "org.litespring.service.v4.PetStoreService");
		assertEquals(visitor.getSuperClassName(), "java.lang.Object");
	...
	public void testGetAnnotation() throws IOException {
		...
		assertEquals("petStore",visitor.getAnnotationAttributes(annotation).getString("value"));
	}
